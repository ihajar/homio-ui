            ...
            <div className="top">
              <div className="post">
                ...
                <div className="address">
                  <CiLocationOn style={{ color: "#3D3D3D", fontSize: "18px" }} />
            ...
            <div className="features">
              <div className="room">
                <div className="feature">
                  <IoBedOutline style={{ color: "#3D3D3D", fontSize: "20px" }} />
                  <span>{singlePostData.bedRooms} {singlePostData.bedRooms > 1 ? "bedrooms" : "bedroom"} </span>
                </div>
                <div className="feature">
                  <LuBath style={{ color: "#3D3D3D", fontSize: "20px" }} />
                  <span>{singlePostData.bathroom} {singlePostData.bathroom > 1 ? "bathrooms" : "bathroom"}</span>
                </div>
                <div className="feature">
                  <LiaRulerCombinedSolid style={{ color: "#3D3D3D", fontSize: "20px" }} />
              ...
              <div className="room">
                ...
                <div className="feature">
                  <IoRestaurantOutline style={{ color: "#3D3D3D", fontSize: "20px" }} />
